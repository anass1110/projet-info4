...
// Restreint l'accès à la page aux seuls profils possédant le rôle administrateur
...
// Extrait la liste complète des utilisateurs enregistrés dans le fichier de stockage persistant
